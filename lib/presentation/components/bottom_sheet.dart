...
class FastCreateCards{
  ...
  static void fastCreateCard(BuildContext context){
   ...
   static void fastCreateCardWithCardType(BuildContext context, CardPrototype cardPrototype){
    showModalBottomSheet(
      context: context,
              ...
              Column(
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      cardPrototype.image.isNotEmpty?
                      Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: NetworkImage(cardPrototype.image),
                              fit: BoxFit.cover,
                            ),
                          )):
                      Container(
